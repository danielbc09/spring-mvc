package dany.springframerwork.spring5recipeapp.bootstrap;

import dany.springframerwork.spring5recipeapp.domain.*;
...
public class RecipeBoostrap implements ApplicationListener<ContextRefreshedEvent>{
    ...
    private List<Recipe> getRecipies() {
        ...
        Optional<Category> americanCategoryOtional = categoryRepository.findByDescription("American");
        ...
        Category americanCategory = americanCategoryOtional.get();
        ...
        //Redundant  : but needed for bidirectional - should be one method call
        guacRecipe.setNotes(guacNotes);

        //Here the guacRecipe always repeat in orden to create new Ingredient
        ...
        guacRecipe.setUrl("http://www.simplyrecipies.com/recipes/perfecet_guacamole/");
